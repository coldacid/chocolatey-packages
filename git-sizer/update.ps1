...
$releases = "$domain/github/git-sizer/releases/latest"
...
function global:au_SearchReplace {
  @{
    ...
    ".\legal\VERIFICATION.txt" = @{
      ...
      "https://raw.githubusercontent.com/github/git-sizer/.*/LICENSE.md" = $Latest.LicenseUrl
    }
...
function global:au_GetLatest {
  ...
  $version = $urls[0] -split '-|.zip' | Select-Object -Last 1 -Skip 3

  $url32 = $domain + ($urls | Where-Object { $_ -like '*386*' })
  $url64 = $domain + ($urls | Where-Object { $_ -like '*amd64*' })

  $releaseNotesUrl = "$domain/github/git-sizer/releases/tag/v" + $version
  $licenseUrl = 'https://raw.githubusercontent.com/github/git-sizer/v' + $version + '/LICENSE.md'
